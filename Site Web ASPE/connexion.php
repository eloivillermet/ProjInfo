<!-- Version finale - Page de connexion -->
...
if(isset($_POST['envoi_connexion'])){
    if(!empty($_POST['pseudo']) && !empty($_POST['mdp'])){
        ...
        if($recupUser->rowCount() > 0){
            ...
            header('Location: index.php'); // Redirection vers la page index après la connexion
            exit;
        } else {
...
<?php endif; ?>
            ...
            <div class="input-field">
              ...
              <input type="text" placeholder="Adresse Mail" name="pseudo">
            </div>
            <div class="input-field">
...
<?php endif; ?>
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          ...
          <img src="img\undraw_stepping_up_g6oo.svg" class="image" alt="">
        </div>
